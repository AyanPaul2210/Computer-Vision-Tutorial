```markdown
# 🧠 Computer Vision Tutorials (NPTEL-Based)

A complete 13-week Computer Vision tutorial, featuring 12 weeks of concept-wise presentations and code examples, plus a revision module.  
Covers image geometry, projective transformations, camera models, stereo vision, feature detection and matching, color and range imaging, and CNN-based vision systems.  
Ideal for hands-on, curriculum-based learning.
...
├── Week3_Homography.pptx
├── Week4_CameraGeometry.pptx
├── Week5_StereoVision.pptx
├── Week6_FeatureDetection.pptx
├── Week7_FeatureMatching.pptx
├── Week8_ColorImaging.pptx
├── Week9_RangeImaging.pptx
├── Week10_MachineLearning.pptx
├── Week11_SparseRepresentation.pptx
...
2. **Launch Jupyter Notebook:**
   ...
   Open any `.ipynb` file to begin exploring the tutorials.

---

## 🧾 Study Material and References

All supporting notes, slides, and open-source implementations are available on my official website:
🔗 [Study Material – Ayan Paul](https://sites.google.com/view/ayans-agribot/teaching/study-material?authuser=0)
